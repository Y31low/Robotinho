...
public class GuiMappa extends JFrame {
    ...
    private class LabelRobot extends JLabel {
        ...
        public LabelRobot() {
            ...
            img=new ImageIcon(new ImageIcon("src/img/giru.png").getImage().getScaledInstance(50,50,Image.SCALE_DEFAULT));
            this.setIcon(img);
            this.setBackground(Color.LIGHT_GRAY);
            this.setBorder(BorderFactory.createLineBorder(Color.BLACK,1));
            this.setOpaque(true);
    ...
    private class LabelGatto extends JLabel {
        ...
        public LabelGatto() {
            ...
            img=new ImageIcon(new ImageIcon("src/img/Gatto.png").getImage().getScaledInstance(50,50,Image.SCALE_DEFAULT));
            this.setIcon(img);
            this.setBackground(Color.LIGHT_GRAY);
            this.setBorder(BorderFactory.createLineBorder(Color.BLACK,1));
            this.setOpaque(true);
